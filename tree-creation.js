...
var deleteTree = function (n, callback) {
  ...
  if (n === walker.data) {
    ...
    if (nodeDelete.children.length === 0)
      nodeDelete.data = null; // Tree only has root node
    else {
  ...
  if (nodeDelete.children.length === 0) {
    ...
    if (!nodeReplace) {
      ...
      if (parent.children[0] === nodeDelete)
        parent.children[0] = nodeDelete.children[1]; // Left child of parent
      else if (parent.children[1] === nodeDelete)
      ...
      if (parent.children[0] === nodeDelete)
        parent.children[0] = nodeReplace; // Left child of parent
      else if (parent.children[1] === nodeDelete)
